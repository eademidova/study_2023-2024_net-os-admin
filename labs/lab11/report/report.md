...
С клиента попытаемся получить доступ к серверу посредством SSH-соединения через пользователя eademidova обычным способом и указав порт 2022(рис. @fig:013):
